...
class _SelectTimeTabState extends State<SelectTimeTab> {
  ...
  void initState() {
    ...
    _controllerDates = FixedExtentScrollController(initialItem: initialDateIndex);
    _controllerMinutes = FixedExtentScrollController(initialItem: initialMinutesIndex);
    _controllerHours = FixedExtentScrollController(initialItem: initialHourIndex);
  ...
  void checkDate() {
    final newDate = DateTime(dates[currentDateIndex].year, dates[currentDateIndex].month, dates[currentDateIndex].day, hours[currentHourIndex], minutes[currentMinutesIndex]);
  ...
  void controllersJump () {
    _controllerDates.animateToItem(currentDateIndex, duration: const Duration(seconds: 1), curve: Curves.bounceIn);
    _controllerHours.animateToItem(currentHourIndex, duration: const Duration(seconds: 1), curve: Curves.bounceIn);
    _controllerMinutes.animateToItem(currentMinutesIndex, duration: const Duration(seconds: 1), curve: Curves.bounceIn);
  }
}
